...
import com.rivetlogic.csvtemplatemailer.model.TemplateModel;
import com.rivetlogic.csvtemplatemailer.model.TemplateSoap;
...
public class TemplateModelImpl extends BaseModelImpl<Template>
	...
	public static final String TABLE_SQL_CREATE = "create table RL_Template (uuid_ VARCHAR(75) null,templateId LONG not null primary key,groupId LONG,companyId LONG,userId LONG,userName VARCHAR(75) null,createDate DATE null,modifiedDate DATE null,name VARCHAR(75) null,value VARCHAR(2000) null)";
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.rivetlogic.csvtemplatemailer.service.util.ServiceProps.get(
				"value.object.entity.cache.enabled.com.rivetlogic.csvtemplatemailer.model.Template"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.rivetlogic.csvtemplatemailer.service.util.ServiceProps.get(
				"value.object.finder.cache.enabled.com.rivetlogic.csvtemplatemailer.model.Template"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.rivetlogic.csvtemplatemailer.service.util.ServiceProps.get(
				"value.object.column.bitmask.enabled.com.rivetlogic.csvtemplatemailer.model.Template"),
			true);
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.rivetlogic.csvtemplatemailer.service.util.ServiceProps.get(
				"lock.expiration.time.com.rivetlogic.csvtemplatemailer.model.Template"));
	...
	public void resetOriginalValues() {
		...
		templateModelImpl._setModifiedDate = false;
	...
	public String toXmlString() {
		...
		sb.append("com.rivetlogic.csvtemplatemailer.model.Template");
